...
def main(iterable, ordertype='orders'):
    ...
    if(ordertype == 'orders'):
            return mapred.report_succuessful_production_bytes(iterable)
    elif(ordertype == 'burned_area'):
            return mapred.report_succuessful_burned_area_bytes(iterable)
    elif(ordertype == 'dswe'):
            return mapred.report_succuessful_dswe_bytes(iterable)
