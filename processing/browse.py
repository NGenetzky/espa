...
def do_sr_browse (sr_filename, scene,
  resolution=settings.default_browse_resolution):
    ...
    base_translate_cmd = ['gdal_translate',
                          ...
                          '-scale', '0', '10000', '0', '255',
                          '-of', 'GTIFF']
# gdal_translate -ot Byte -scale 0 10000 0 255 -of ENVI LT50460282002042EDC01_toa_band5.img browse_5.img
...
# gdal_translate -ot Byte -scale 0 10000 0 255 -of ENVI LT50460282002042EDC01_toa_band4.img browse_4.img
...
# gdal_translate -ot Byte -scale 0 10000 0 255 -of ENVI LT50460282002042EDC01_toa_band3.img browse_3.img
...
# gdal_merge_simple -of ENVI -in browse_5.img -in browse_4.img -in browse_3.img -out final.img
...
# gdalwarp -of ENVI -dstalpha -srcnodata 0 -t_srs EPSG:4326 final.img warped.img
    cmd = ['gdalwarp',
           '-dstalpha',
           '-srcnodata', '0',
           '-t_srs', 'EPSG:4326',
    ...
    #-------------------------------------------------------------------------
    # Resize and rename
# gdal_translate -ot INT16 -of ENVI -outsize 50 50 -a_nodata -9999 warped.img browse.img
# Should probably use gdalwarp to set the resolution, because outsize in gdal_translate is a percentage.  This step may not even be needed then, because it could be handled in the previous gdalwarp step.
    cmd = ['gdal_translate',
           '-co', 'COMPRESS=DEFLATE',
           '-co', 'PREDICTOR=2',
